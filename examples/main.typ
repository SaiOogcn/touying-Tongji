...
#let fletcher-stroke = if deck-mode == "dark" {
  rgb("#E2E2E6")
} else {
  rgb("#001C3B")
}
...
#cetz-canvas({
  ...
  rect((0, 0), (5, 5), stroke: (paint: cetz-stroke, thickness: 1.2pt))

  (pause,)

  rect((0, 0), (1, 1), stroke: (paint: cetz-stroke, thickness: 1.2pt))
  rect((1, 1), (2, 2), stroke: (paint: cetz-stroke, thickness: 1.2pt))
  rect((2, 2), (3, 3), stroke: (paint: cetz-stroke, thickness: 1.2pt))

  (pause,)

  line((0, 0), (2.5, 2.5), name: "line", stroke: (paint: cetz-stroke, thickness: 1.2pt))
})
...
#let open-label = box(
  ...
  radius: .25em,
  inset: (x: .35em, y: .12em),
  text(fill: rgb("#00223D"), "open(path)"),
)

#fletcher-diagram(
  node-stroke: (paint: fletcher-stroke, thickness: .1em),
  node-fill: gradient.radial(blue.lighten(80%), blue, center: (30%, 20%), radius: 80%),
  spacing: 4em,
  edge((-1, 0), "r", "-|>", open-label, label-pos: 0, label-side: center, stroke: (paint: fletcher-stroke, thickness: .1em)),
  node((0, 0), `reading`, radius: 2em),
  edge((0, 0), (0, 0), `read()`, "--|>", bend: 130deg, stroke: (paint: fletcher-stroke, thickness: .1em)),
  pause,
  edge(`read()`, "-|>", stroke: (paint: fletcher-stroke, thickness: .1em)),
  node((1, 0), `eof`, radius: 2em),
  pause,
  edge(`close()`, "-|>", stroke: (paint: fletcher-stroke, thickness: .1em)),
  node((2, 0), `closed`, radius: 2em, extrude: (-2.5, 0)),
  edge((0, 0), (2, 0), `close()`, "-|>", bend: -40deg, stroke: (paint: fletcher-stroke, thickness: .1em)),
)
...
#slide[
  - 您可以使用：
    ...
    ```
    获取本模板，并基于 `template/main.typ` 创建演示文稿项目。

  - 本模板仓库位于 #link("https://github.com/SaiOogcn/touying-Tongji")，欢迎关注与贡献。
]
